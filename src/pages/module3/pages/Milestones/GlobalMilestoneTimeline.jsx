        ...
        <main className="flex-1 ml-72">
          ...
          <div className="bg-gradient-to-b from-[#00d09c]/10 to-transparent border-b border-gray-800/50 px-10 py-12">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-[#121826] px-6 py-3 rounded-xl border border-gray-800 flex gap-8">
                <div className="text-center">
                  <div className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Projects</div>
                  <div className="text-xl font-black text-[#00d09c]">{data?.totalProjects}</div>
                </div>
                <div className="text-center border-l border-gray-800 pl-8">
                  ...
                  <div className="text-xl font-black text-white">{data?.totalMilestones}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-10">
            {data?.projectTimelines.length === 0 ? (
              <div className="bg-[#121826]/40 rounded-2xl border border-dashed border-gray-800 p-20 text-center">
                ...
                <p className="text-gray-400 font-bold text-lg">No projects found to display</p>
              </div>
            ) : (
              <div className="grid grid-cols-12 gap-8">
                    ...
                    <button
                      ...
                      className={`w-full text-left p-4 rounded-xl border transition-all flex items-center gap-3 ${
                        selectedProjectIndex === index
                          ? 'bg-[#00d09c]/10 border-[#00d09c] text-white shadow-[0_0_20px_rgba(0,208,156,0.1)]'
                          : 'bg-[#121826]/50 border-gray-800 text-gray-400 hover:border-gray-700'
                      }`}
                    >
                      <Briefcase size={18} className={selectedProjectIndex === index ? 'text-[#00d09c]' : 'text-gray-600'} />
                ...
                <div className="col-span-12 lg:col-span-9">
                  {currentProject && (
                    <div className="bg-[#121826] rounded-2xl border border-gray-800 overflow-hidden shadow-2xl">
                      {/* Project Meta */}
                      <div className="p-8 border-b border-gray-800 bg-gray-800/20">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                          <div>
                            <h2 className="text-2xl font-black text-white mb-2">{currentProject.projectName}</h2>
                            <div className="flex items-center gap-4 text-sm font-bold text-gray-400">
                              <span className="flex items-center gap-2"><Calendar size={14} className="text-[#00d09c]" /> {formatDate(currentProject.projectStartDate)}</span>
                              <ArrowRight size={14} />
                              <span className="flex items-center gap-2"><Calendar size={14} className="text-[#00d09c]" /> {formatDate(currentProject.projectEndDate)}</span>
                            </div>
                          </div>
                          <div className="bg-gray-900/50 px-4 py-2 rounded-lg border border-gray-800 text-[#00d09c] font-black text-sm">
                      ...
                      <div className="p-8">
                        {currentProject.milestones.length === 0 ? (
                          ...
                          <div className="space-y-8">
                            {currentProject.milestones.sort((a,b) => new Date(a.startDate) - new Date(b.startDate)).map((milestone, idx) => {
                              ...
                              return (
                                <div key={milestone.id} className="relative">
                                  ...
                                  {/* Bar container */}
                                  <div className="h-10 bg-gray-900/50 rounded-lg relative overflow-hidden group border border-gray-800/50">
                                    {/* The Milestone Bar */}
                                    <div 
                            ...
                            <div className="pt-8 mt-8 border-t border-gray-800/50 flex justify-between text-[10px] font-black text-gray-600 uppercase tracking-widest">
