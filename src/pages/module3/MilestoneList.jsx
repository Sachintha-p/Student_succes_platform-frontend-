          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            ...
            <div className="ml-auto">
              <select
                ...
                className="bg-gray-800/40 text-slate-900 px-4 py-2 rounded-lg border border-slate-200 font-bold focus:outline-none focus:border-indigo-500 transition-colors"
              >
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              ...
              <div className="flex gap-4 pt-6 border-t border-slate-200">
                <button
                  ...
                  className="flex-1 bg-gray-800/50 hover:bg-gray-800 text-slate-900 px-6 py-3 rounded-lg font-bold transition-all"
                >
                  Cancel
                </button>
                <button
