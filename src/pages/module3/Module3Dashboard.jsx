...
const Module3Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="pt-24">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-[#121826] to-[#1a2332] border-b border-slate-200 py-12">
          <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-3 bg-indigo-600/10 border border-[#00d09c]/30 rounded-lg px-4 py-2 w-fit">
                <div className="w-2.5 h-2.5 bg-indigo-600 rounded-full"></div>
                <span className="text-indigo-600 font-bold text-sm">Logged in as: {dashboardAdmin?.adminEmail}</span>
              </div>
            </div>
            <button
              onClick={handleLogout}
              className="flex items-center gap-2 text-slate-500 hover:text-red-400 px-6 py-3 rounded-xl transition-all border border-slate-200 hover:border-red-400/30 font-bold"
            >
              <LogOut size={18} />
              Logout
            </button>
          ...
          {loading ? (
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white rounded-2xl border border-slate-200 p-8 hover:border-indigo-500/50 transition-all">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-slate-500 text-sm font-bold uppercase tracking-wider">Total Events</p>
                      <p className="text-4xl font-black text-indigo-600 mt-2">{events.length}</p>
                    </div>
                    <Calendar className="text-indigo-600/30 size-12" />
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-8 hover:border-indigo-500/50 transition-all">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-slate-500 text-sm font-bold uppercase tracking-wider">Total Meetings</p>
                      <p className="text-4xl font-black text-indigo-600 mt-2">{meetings.length}</p>
                    </div>
                    <Video className="text-indigo-600/30 size-12" />
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-8 hover:border-indigo-500/50 transition-all">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-4xl font-black text-indigo-600 mt-2">{projects.length}</p>
                    </div>
                    <Briefcase className="text-indigo-600/30 size-12" />
                  </div>
                </div>
              </div>
              ...
              <section>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-3xl font-black text-slate-900">Events ({events.length})</h2>
                </div>
                {events.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {events.map((event) => (
                      <div
                        key={event.id}
                        className="bg-white rounded-2xl border border-slate-200 hover:border-indigo-500/50 transition-all p-6 hover:shadow-[0_15px_40px_rgba(0,208,156,0.1)]"
                      >
                        <div className="flex justify-between items-start mb-4">
                          <span className="bg-indigo-600/15 text-indigo-600 text-[8px] font-black px-3 py-1.5 rounded-full uppercase tracking-wider border border-[#00d09c]/30">
                  ...
                  <div className="bg-white/40 rounded-2xl border border-dashed border-slate-200 py-16 text-center">
              ...
              <section>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-3xl font-black text-slate-900">Meetings ({meetings.length})</h2>
                </div>
                {meetings.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <section>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-3xl font-black text-slate-900">Projects ({projects.length})</h2>
                </div>
                {projects.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {projects.map((project) => (
                      <div
                        key={project.id}
                        className="bg-white rounded-2xl border border-slate-200 hover:border-indigo-500/50 transition-all p-6 hover:shadow-[0_15px_40px_rgba(0,208,156,0.1)] cursor-pointer"
                      ...
                      >
                        ...
                        <button
                          onClick={() => navigate(`/module3-projects/${project.id}`)}
                          className="w-full bg-indigo-600 hover:bg-[#00e6ae] text-gray-900 py-2 rounded-lg font-bold transition-all text-sm active:scale-95"
                        >
                          View Kanban Board
                        </button>
                      </div>
      ...
      {isEditModalOpen && editingEvent && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-white border border-slate-200 rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
            <div className="p-6 border-b border-slate-200 flex justify-between items-center bg-[#1a2332]">
            ...
            <form onSubmit={handleUpdateEvent} className="p-8 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="col-span-2">
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Event Title</label>
                  <input
                    type="text"
                    required
                ...
                <div className="col-span-2">
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Description</label>
                  <textarea
                    rows="3"
                    value={editingEvent.description || ''}
                    onChange={(e) => setEditingEvent({ ...editingEvent, description: e.target.value })}
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:border-indigo-500 transition-all resize-none"
                  ></textarea>
                </div>

                <div>
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Event Date</label>
                  <input
                    type="datetime-local"
                    required
                ...
                <div>
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Category</label>
                  <select
                ...
                <div>
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Venue / Link</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Max Attendees</label>
                  <input
                    type="number"
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <label htmlFor="isOnlineEdit" className="text-slate-600 font-bold text-sm cursor-pointer">Online Event</label>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-5 h-5 accent-[#00d09c]"
                  />
                  <label htmlFor="isPublishedEdit" className="text-slate-600 font-bold text-sm cursor-pointer">Published</label>
                </div>
              </div>
              ...
              <div className="flex gap-4 pt-4">
                <button
                  type="button"
                  onClick={() => setIsEditModalOpen(false)}
                  className="flex-1 px-6 py-4 rounded-xl border border-slate-200 text-slate-600 font-bold hover:bg-slate-100 transition-all"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={isUpdating}
                  className="flex-1 bg-indigo-600 hover:bg-[#00e6ae] text-gray-900 font-black px-6 py-4 rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {isUpdating ? (
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-white border border-slate-200 rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleUpdateMeeting} className="p-8 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="col-span-2">
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Meeting Title</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Group ID</label>
                  <input
                    type="number"
                    required
                ...
                <div>
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Location</label>
                  <input
                    type="text"
                ...
                <div className="col-span-2">
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Meeting Link</label>
                  <input
                    type="text"
                ...
                <div className="col-span-2">
                  <label className="block text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">Proposed Dates</label>
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full py-3 border border-dashed border-slate-300 rounded-xl text-gray-500 font-bold hover:border-indigo-500 hover:text-indigo-600 transition-all"
                    >
