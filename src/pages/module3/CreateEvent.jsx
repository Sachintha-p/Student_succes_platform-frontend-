      ...
      <div className="flex">
        ...
        <div className="bg-gradient-to-b from-[#00d09c]/10 to-transparent border-b border-slate-200/50 px-10 py-12">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-6">Create New Event</h1>
              <p className="text-slate-500 text-lg font-medium">Organize and promote a campus event</p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            ...
            <div className="flex gap-4 pt-6 border-t border-slate-200">
              <button
                type="button"
                onClick={() => navigate('/module3')}
                className="flex-1 bg-gray-800/60 hover:bg-gray-700/70 text-slate-600 py-3.5 rounded-lg font-bold transition-all active:scale-95"
              >
                Cancel
              </button>
              <button
